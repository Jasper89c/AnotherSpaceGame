...
{
    public class GuardianModel : PageModel
    {
        ...
        public void OnGet()
        {
            // Get the faction modifiers for guardian
            var (factionTaxModifier, factionCommercialModifier, factionIndustryModifier,
                 factionAgricultureModifier, factionMiningModifier, factionDemandForGoods, infrastructureMaintenanceCost) = GetFactionModifiers(Faction.Guardian);
            ...
            MaxmumColonies = GetColonyCapForFaction(Faction.Guardian).ToString();
