...
{
    public class ViralModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            var (factionTaxModifier, factionCommercialModifier, factionIndustryModifier,
                 factionAgricultureModifier, factionMiningModifier, factionDemandForGoods, infrastructureMaintenanceCost) = GetFactionModifiers(Faction.Viral);
            ...
            MaxmumColonies = GetColonyCapForFaction(Faction.Viral).ToString();
