...
{
    public class TerranModel : PageModel
    {
        ...
        public void OnGet()
        {
            // Get the faction modifiers for Terran
            var (factionTaxModifier, factionCommercialModifier, factionIndustryModifier,
                 factionAgricultureModifier, factionMiningModifier, factionDemandForGoods, infrastructureMaintenanceCost) = GetFactionModifiers(Faction.Terran);
            ...
            MaxmumColonies = GetColonyCapForFaction(Faction.Terran).ToString();
