...
{
    public class MarauderModel : PageModel
    {
        ...
        public void OnGet()
        {
            // Get the faction modifiers for Marauder
            var (factionTaxModifier, factionCommercialModifier, factionIndustryModifier,
                 factionAgricultureModifier, factionMiningModifier, factionDemandForGoods, infrastructureMaintenanceCost) = GetFactionModifiers(Faction.Marauder);
            ...
            MaxmumColonies = GetColonyCapForFaction(Faction.Marauder).ToString();
