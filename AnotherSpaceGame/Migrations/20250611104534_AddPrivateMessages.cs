        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrivateMessages_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PrivateMessages_AspNetUsers_ApplicationUserId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivateMessages_ApplicationUserId",
                table: "PrivateMessages",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PrivateMessages_ApplicationUserId1",
                table: "PrivateMessages",
