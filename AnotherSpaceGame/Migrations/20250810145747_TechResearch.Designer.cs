...
namespace AnotherSpaceGame.Migrations
{
    ...
    [Migration("20250810145747_TechResearch")]
    partial class TechResearch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnotherSpaceGame.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnotherSpaceGame.Models.GalaxyEnd", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnotherSpaceGame.Models.UWShips", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("UWship1")
                        .HasColumnType("bit");

                    b.Property<bool>("UWship2")
                        .HasColumnType("bit");

                    b.Property<bool>("UWship3")
                        .HasColumnType("bit");

                    b.Property<bool>("UWship4")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AnotherSpaceGame.Models.UserResearchProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserResearchProgress");
                });
            ...
            modelBuilder.Entity("AnotherSpaceGame.Models.UWShips", b =>
                {
                    b.HasOne("AnotherSpaceGame.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("UWShips")
                        .HasForeignKey("AnotherSpaceGame.Models.UWShips", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
